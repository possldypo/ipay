...
<div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6 jQueryEqualHeight3">
            <div class="card">
                <img class="card-img-top" src="${basePath}/static/js/lib/pinterest_grid/img/12.jpg" alt="Card image cap">
                <div class="card-body">
                    <h4 class="card-title">MD5</h4>
                    <p class="card-text">md5</p>
                    <a href="${basePath}/utils/to_md5" class="btn btn-primary">Go somewhere</a>
                </div>
            </div>
        </div>
